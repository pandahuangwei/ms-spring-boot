...
import com.ml.entity.sys.Column;
import com.ml.entity.sys.Table;
...
public class Generators {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new RtException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new RtException("获取配置文件失败，", e);
        }
    }
